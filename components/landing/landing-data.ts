export const faqData = [
  {
    ...
    a: "Legacy platforms charge flat monthly fees regardless of your size and lock features behind tiers. Barbellist charges per member — cents, not hundreds of dollars — with every feature included from day one. It was built for independent gyms, not enterprise chains.",
  },
  {
  ...
  {
    q: "What happens after the first 3 months at $0.10/member?",
    a: "You move to the Standard rate of $0.25 per member per month — still a fraction of legacy pricing. Nothing changes about your data or features, and there is no lock-in. You can cancel any time.",
  },
  {
